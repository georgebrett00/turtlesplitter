...
function autonomousMine()
    ...
    while MINER_MAX_RUNS == 0 or run < MINER_MAX_RUNS do
        ...
        -- TRUE HOME is the authoritative physical origin. calibrate() may
        -- previously have rewritten location.y to an approximate world depth,
        -- so re-anchor the miner coordinate system here before descending.
