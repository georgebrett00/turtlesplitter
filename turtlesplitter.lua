...
CRAFTING_RECIPES = {
    ...
    ['minecraft:paper'] = {
        'minecraft:sugar_canes', 'minecraft:sugar_canes', 'minecraft:sugar_canes',
    },
...
CRAFTING_TREE = {
    ...
    ['computercraft:disk'] = {count = 1, components = {
        ...
        ['minecraft:paper'] = {count = 1, components = {
            ...
            ['minecraft:sugar_canes'] = {count = 1, subterranean = false},
        }},
    }},
...
function explore()
    ...
    while next(lacked) ~= nil and refuelGood do
        ...
        if block_found then
            if is_block_forward and data_block_forward.name == 'minecraft:sugar_canes' then
                while is_block_forward and data_block_forward.name == 'minecraft:sugar_canes' do
                    go('up')
...
function createFarm()
    ...
    PLACE.down()
    goAbsolute('up')
    selectItem('minecraft:sugar_canes')
    PLACE.down()
    goAbsolute('up')
end
...
function genesis()
    ...
    local sugar_needed = 5 - original_items['minecraft:sugar_canes'].count
...
function manualChest()
    ...
    while true do
        ...
        for slot = 1, 16 do
            ...
            if item and item.name == 'minecraft:sugar_canes' then
