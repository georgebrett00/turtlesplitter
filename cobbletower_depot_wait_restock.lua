...
local function restockAtDepot(cobbleWanted, panesWanted)
    while true do
        ...
        if paneAvailable and cobbleAvailable then
            ...
            if missingPanes>0 or missingCobble>0 then
                print("Waiting for depot supplies:")
                if missingPanes>0 then print("  "..missingPanes.." more glass panes") end
                if missingCobble>0 then print("  "..missingCobble.." more cobblestone") end
